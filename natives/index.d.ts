...
declare module "natives" {
  ...
  */
  ...
  export function getFocusPedOnScreen(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number, p8: number): Player | number;
  ...
  */
  ...
  export function getEntityIndexOfCutsceneEntity(cutsceneEntName: string, modelHash: number): Entity | number;
  ...
  * @param explosionType See ADD_EXPLOSION.
  */
  export function getEntityInsideExplosionSphere(explosionType: number, x: number, y: number, z: number, radius: number): Entity | number;
  ...
  * @param explosionType See ADD_EXPLOSION.
  */
  export function getEntityInsideExplosionArea(explosionType: number, x1: number, y1: number, z1: number, x2: number, y2: number, z2: number, radius: number): Entity | number;
  ...
  */
  ...
  export function networkGetHostOfThisScript(): Player | number;
  ...
  * @param p2 = 0
  */
  export function networkGetHostOfScript(scriptName: string, p1: number, p2: number): Player | number;
  ...
  */
  export function participantId(): Player | number;
  ...
  */
  ...
  export function netToVeh(netHandle: number): Vehicle | number;

  /**
  * gets the ped id of a network id
  */
  export function netToPed(netHandle: number): Player | number;
  ...
  */
  ...
  export function networkGetPlayerFromGamerHandle(networkHandle: number): [Player | number, number];
  ...
  */
  export function createPed(pedType: number, modelHash: number, x: number, y: number, z: number, heading: number, isNetwork: boolean, bScriptHostPed: boolean): Player | number;
  ...
  */
  export function getPedAsGroupMember(groupID: number, memberNumber: number): Player | number;
  ...
  */
  export function getRandomPedAtCoord(x: number, y: number, z: number, xRadius: number, yRadius: number, zRadius: number, pedType: number): Player | number;
  ...
  */
  export function getPlayersLastVehicle(): Vehicle | number;

  /**
  * Returns the same as PLAYER_ID and NETWORK_PLAYER_ID_TO_INT
  */
  export function getPlayerIndex(): Player | number;

  /**
  * @returns Simply returns whatever is passed to it (Regardless of whether the handle is valid or not).
  */
  export function intToPlayerindex(value: number): Player | number;
  ...
  */
  export function playerPedId(): Player | number;
  ...
  */
  export function createVehicle(modelHash: number, x: number, y: number, z: number, heading: number, isNetwork: boolean, bScriptHostVeh: boolean, p7: boolean): Vehicle | number;
  ...
  * freighttrailer
  */
  export function createMissionTrain(unkVariation: number, x: number, y: number, z: number, direction: boolean): Vehicle | number;
  ...
  */
  ...
  export function getRandomVehicleFrontBumperInSphere(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number): Vehicle | number;

  export function getRandomVehicleBackBumperInSphere(p0: number, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number): Vehicle | number;
